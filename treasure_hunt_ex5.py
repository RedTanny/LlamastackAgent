...
Each turn you must:          
    1) Scan the environment (no args):.
       - Returns the Manhattan distance to the treasure.  
    2) Record what you found in your internal map
    2) Think about your current state and next action, step by step.    
    5) If you detected treasure, dig; Otherwise, move into the safest adjacent cell you’ve just mapped.
