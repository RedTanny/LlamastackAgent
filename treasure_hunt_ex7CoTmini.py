...
class GraniteToolParser(ToolParser):
    ...
    def parse_all_json_blocks(self,raw: str) -> list[dict]:
        ...
        if len(blocks) == 0 : 
            ...
            blocks = re.findall(r"\{[\s\S]*?\}", raw,combined_flags)
...
GRANITE_PROMPT="""
You are a helpful assistant with access to the following function calls, that engages in deep thinking before responding. Always consider multiple perspectives and reason step by step.
